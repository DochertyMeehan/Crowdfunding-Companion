<template>
  <h1>FAQ</h1>
   ...
   <h6>Crowdfunding Companion was created by 6 software developers who wanted to make it easy to fundraise for any need. Whether it be due to unforeseen circumstances, 
    ...
    <h6>To create a campaign, simply click on “Create Campaign” and fill out the form. From there, you can edit or delete a campaign that is no longer needed. You can also 
        ...
        Vote to have the money spent, in whatever manner you feel is most appropriate. </h6>
...
<h6>Absolutely! Crowdfunding Companion welcomes individuals and organizations to create and promote their fundraising campaigns on our platform. Simply follow the 
    guidelines for creating a campaign and share it with your network to maximize visibility and support.</h6>
